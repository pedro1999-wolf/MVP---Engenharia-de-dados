...
**Todas as tabelas de consulta podem ser vistas no Notebook Databricks do trabalho, que foi exportado do Databricks community como notebook python e permanece com a vizualização de todos os outputs**
